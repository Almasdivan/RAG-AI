...
Original file is located at
    https://colab.research.google.com/drive/1jdGe6kJlmOxVb-V8ObZN8Die3Lo2a5md
"""
...
loader = TextLoader("data/About RAG.txt")
docs = loader.load()
...
#text generation-> to build conversation between with AI in chatbot
pipe = pipeline(
    "text-generation",
...
response = rag_chain("What is RAG?")
print(response)
